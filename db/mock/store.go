...
// ListTransger mocks base method.
func (m *MockStore) ListTransger(arg0 context.Context, arg1 db.ListTransgerParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransger", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransger indicates an expected call of ListTransger.
func (mr *MockStoreMockRecorder) ListTransger(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransger", reflect.TypeOf((*MockStore)(nil).ListTransger), arg0, arg1)
}
